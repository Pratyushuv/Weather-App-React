  ...
  return (
    <div className=" h-90 w-170 m-auto rounded-3xl">
      ...
      <ul className="Current flex flex-col items-center justify-center h-64 gap-5">
        <li className="flex gap-1 text-3xl font-bold ">
        ...
        <li className="flex gap-1 text-1xl font-bold ">
          <span className="self-center">
            <svg
              width="25px"
              height="30px"
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                <path
                  ...
                  fill="#000000"
                ></path>{" "}
                <path d="M4 16L5 11H3L2 16H4Z" fill="#000000"></path>{" "}
                <path d="M8 16L9 11H7L6 16H8Z" fill="#000000"></path>{" "}
                <path d="M13 11L12 16H10L11 11H13Z" fill="#000000"></path>{" "}
              </g>
            </svg>
          </span>
